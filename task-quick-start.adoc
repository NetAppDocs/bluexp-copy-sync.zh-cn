...
您应该已经开始使用Cloud Manager、其中包括登录、设置帐户以及可能部署Connector和创建工作环境。
...
[role="quick-margin-para"]
Cloud Volumes ONTAP 和内部ONTAP 集群需要使用连接器。

* https://docs.netapp.com/us-en/cloud-manager-setup-admin/concept-overview.html["了解如何开始使用Cloud Manager"^]
