...
=== Cloud Sync 如何计费以及如何管理我的订阅？

在 14 天免费试用结束后、有两种方式可以支付同步关系的费用。第一种选择是从 AWS 或 Azure 订阅、这使您可以按需付费或每年付款。第二种选择是直接从 NetApp 购买许可证。在每种情况下、您的订阅都将通过您的提供商市场进行管理、而*不是*通过Cloud Sync 用户界面进行管理。
